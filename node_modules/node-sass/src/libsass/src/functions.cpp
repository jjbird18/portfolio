...
namespace Sass {
  ...
  namespace Functions {
    ...
    Signature rgb_sig = "rgb($teal, $green, $blue)";
    BUILT_IN(rgb)
    {
      if (
        special_number(Cast<String_Constant>(env["$teal"])) ||
    ...
    Signature rgba_4_sig = "rgba($teal, $green, $blue, $alpha)";
    BUILT_IN(rgba_4)
    {
      if (
        special_number(Cast<String_Constant>(env["$teal"])) ||
    ...
    Signature adjust_color_sig = "adjust-color($color, $teal: false, $green: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(adjust_color)
    {
      Color_Ptr color = ARG("$color", Color);
      Number_Ptr r = Cast<Number>(env["$teal"]);
      ...
      if (rgb) {
        double rr = r ? DARG_R_BYTE("$teal") : 0;
    ...
    Signature scale_color_sig = "scale-color($color, $teal: false, $green: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(scale_color)
    {
      ...
      if (rgb) {
        double rscale = (r ? DARG_R_PRCT("$teal") : 0.0) / 100.0;
    ...
    Signature change_color_sig = "change-color($color, $teal: false, $green: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
